...
'-I',
(os.environ['WORKSPACE_DIR'] + '/ksync/client/core/inc'),
'-I',
(os.environ['WORKSPACE_DIR'] + '/ksync/client/plain/inc'),
'-I',
(os.environ['WORKSPACE_DIR'] + '/ksync/client/ncurses/inc'),
'-I',
(os.environ['WORKSPACE_DIR'] + '/ksync/core/inc'),
'-I',
(os.environ['WORKSPACE_DIR'] + '/ksync/ui/ncurses/inc'),
'-I',
(os.environ['WORKSPACE_DIR'] + '/ksync/comm/core/inc'),
'-I',
(os.environ['WORKSPACE_DIR'] + '/ksync/comm/nanomsg/inc'),
'-I',
(os.environ['WORKSPACE_DIR'] + '/ksync/comm/zeromq/inc'),
'-I',
